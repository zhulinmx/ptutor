...
public class PopuTimeView extends RelativeLayout{
    private View contentView;
    private TimeSelectorView timeSelectorView;
    private PopupWindow mPopupWindow;
    private String mDefault = "—°‘Ò ±º‰";
    ...
    public PopuTimeView(Context context) {
        this(context, null);
    }

    public PopuTimeView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public PopuTimeView(Context context, AttributeSet attrs, int defStyleAttr) {
        this(context, attrs, defStyleAttr, 0);
    }

    public PopuTimeView(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) 
    {
        super(context, attrs, defStyleAttr);
        float density = context.getResources().getDisplayMetrics().density;

        mTextView = new TextView(context);
        mTextView.setId(R.id.TimeTextViewId);
        ...
        contentView = LayoutInflater.from(context).inflate(R.layout.popu_selector, null);


        timeSelectorView = (TimeSelectorView) contentView.findViewById(R.id.tmselector);
